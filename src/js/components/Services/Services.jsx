...
import { UilBracketsCurly, UilArrow } from "@iconscout/react-unicons";
      ...
      <div className="services__container container grid">
        <div className="services__content">
          <div>
            ...
            <UilArrow className="uil uil-arrow services__icon" />
        ...
        <div className="services__content">
          <div>
            ...
            <UilBracketsCurly className="uil uil-brackets-curly services__icon" />
