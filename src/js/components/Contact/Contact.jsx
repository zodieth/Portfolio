        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <UilEnvelope className="bx bx-mail-send contact__card-icon" />

              <h3 className="contact-card-title">Email</h3>
              <span className="contact__card-data">
                mateoiglesias0@gmail.com
              </span>
            ...
            <div className="contact__card">
              ...
              <UilGithub className="bx  bxl-linkedin-square contact__card-icon" />

              <h3 className="contact-card-title">Linkedln</h3>
              <span className="contact__card-data">Mateo Iglesias</span>
            ...
            <div className="contact__card">
              ...
              <UilGithub className="bx bx bxl-github contact__card-icon" />

              <h3 className="contact-card-title">GitHub</h3>
              <span className="contact__card-data">zodieth</span>
