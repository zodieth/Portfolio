        ...
        <div className="qualification__sections">
          ...
          >
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">San Carlos School</h3>
                <span className="qualification__subtitle">Business</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i>
                  2021
                </div>
          ...
          >
            ...
            <div className="qualification__data">
              ...
              <div>
                ...
                <span className="qualification__subtitle">zodi</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i>
                  2022
                </div>
